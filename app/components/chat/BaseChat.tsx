        ...
        {[...modelList]
          ...
          .map((modelOption) => (
            <option key={modelOption.name} value={modelOption.name}>
              {modelOption.label.replace("qwen2.5-coder", "Coding Assitant").replace("494.03M", "Parameters").replace("32.8B", "Parameters").replace("14.8B", "Parameters").replace("7.6B", "Parameters").replace("3.1B","Parameters")}
            </option>
          ))}
      </select>
          ...
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow min-w-[var(--chat-min-width)] h-full')}>
            {!chatStarted && (
              <div id="intro" className="mt-[26vh] max-w-chat mx-auto text-center">
                <h1 className="text-2xl font-bold text-bolt-elements-textPrimary mb-4 animate-fade-in">
                  Persistence Above Talent
                </h1>
                <p className="text-xl mb-8 text-bolt-elements-textSecondary animate-fade-in animation-delay-200">
                  AI Software Engineering Assistant for Finsocial Team
                </p>
              </div>
            )}
            <div
              ...
              >
                ...
                >
                  <textarea
                    ...
                    placeholder="Prompt Generate Code Debug Deploy"
                    translate="no"
                  />
                  <ClientOnly>
                    {() => (
